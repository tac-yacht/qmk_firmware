...
#ifdef KEYBOARD_keebio_irisextendarrow_rev1
    #include "rev1.h"
#elif KEYBOARD_keebio_irisextendarrow_rev1_led
    #include "rev1_led.h"
#elif KEYBOARD_keebio_irisextendarrow_rev2
    #include "rev2.h"
#else
    #include "rev3.h"
#endif
...
#define LAYOUT_kc( \
    ...
    LAYOUT( \
        ...
        KC_##LX0, KC_##LX1, KC_##LX2, KC_##LX3,                               KC_##RX0, KC_##RX1, KC_##RX2, KC_##RX3\
    )
